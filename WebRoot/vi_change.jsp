...
<body>
  ...
  <a href="index.jsp">返回首页</a>
    ...
    <form action="changeInformation" method="get" onsubmit="return checkAll()">
    	<table align="center" width="500">
    		...
    		<tr>
    			...
    			<td><input type="password" class="box" name="c_visitorpwd" id="password" onblur=checkPasswd()></td>
    			<td ><p id="passwdspan"></p></td>
    		</tr>
    		<tr>
    			<td align="right" width="30%">确认密码</td>
    			<td><input type="password" class="box" name="c_revisitorpwd" id="repassword" onblur=checkSame()></td>
    			<td ><p id="repasswdspan"></p></td>
    		</tr>
    		<tr>
    			<td align="right" width="30%">昵称</td>
    			<td><input type="text" class="box" name="c_visitorname" id="Nicheng" onblur=checkNicheng()></td>
